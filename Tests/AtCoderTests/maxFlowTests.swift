...
//        throw XCTSkip()
        ...
        XCTAssertEqual(0, g.addEdge(0, 1, 1));
        XCTAssertEqual(1, g.addEdge(0, 2, 1));
        XCTAssertEqual(2, g.addEdge(1, 3, 1));
        XCTAssertEqual(3, g.addEdge(2, 3, 1));
        XCTAssertEqual(4, g.addEdge(1, 2, 1));
        ...
        XCTAssertEqual([true, false, false, false], g.minCut(0));
    }
    
    func testNotSimple() throws {
        var g = mf_graph<Int>(2);
        XCTAssertEqual(0, g.addEdge(0, 1, 1));
        XCTAssertEqual(1, g.addEdge(0, 1, 2));
        XCTAssertEqual(2, g.addEdge(0, 1, 3));
        XCTAssertEqual(3, g.addEdge(0, 1, 4));
        XCTAssertEqual(4, g.addEdge(0, 1, 5));
        XCTAssertEqual(5, g.addEdge(0, 0, 6));
        XCTAssertEqual(6, g.addEdge(1, 1, 7));
        ...
        XCTAssertEqual([true, false], g.minCut(0));
    }
    
    func testCut() throws {
        var g = mf_graph<Int>(3);
        XCTAssertEqual(0, g.addEdge(0, 1, 2));
        XCTAssertEqual(1, g.addEdge(1, 2, 1));
        ...
        XCTAssertEqual([true, true, false], g.minCut(0));
    }
    ...
    func testTwice() throws {
        ...
        XCTAssertEqual(0, g.addEdge(0, 1, 1));
        XCTAssertEqual(1, g.addEdge(0, 2, 1));
        XCTAssertEqual(2, g.addEdge(1, 2, 1));
    ...
    func testBound() throws {
        ...
        let INF = Int.max;
        var g = mf_graph<Int>(3);
        XCTAssertEqual(0, g.addEdge(0, 1, INF));
        XCTAssertEqual(1, g.addEdge(1, 0, INF));
        XCTAssertEqual(2, g.addEdge(0, 2, INF));
    ...
    func testSelfLoop() throws {
        var g = mf_graph<Int>(3);
        XCTAssertEqual(0, g.addEdge(0, 0, 100));
