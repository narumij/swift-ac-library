        ...
        if h &- len == 1 {
          ...
          for s in 0 ..< 1 << len {
            ...
            for i in 0 ..< p {
              ...
              let a1na3imag: UInt = 1 &* mint(ull: a1 &+ mod2 &- a3).value() &* imag.value()
        ...
        if len == 1 {
          ...
          for s in 0 ..< 1 << (len &- 1) {
            ...
            for i in 0 ..< p {
              ...
              a[i &+ offset] = l + r
              a[i &+ offset &+ p] = mint(
              ull: (UInt(l.value() &- r.value() &+ UInt(mod.umod))
                    &* irot.value()))
            }
            if s &+ 1 != 1 << (len &- 1) {
          ...
          for s in 0 ..< 1 << (len &- 2) {
            ...
            for i in 0 ..< p {
              ...
              let a2na3iimag: UInt = mint(ull: (umod &+ a2 &- a3) &* iimag.value()).value()
